...
void StopWatch::GetFrequency(unsigned long long mu_seconds) {
#ifdef __WIN32__
...
void StopWatch::StopCounting(int counter_index) {
...
double StopWatch::GetLastMeasure() {
...
unsigned long long  StopWatch::__rdtsc( void ){
  unsigned a, d;
